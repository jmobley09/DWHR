...
import { columns, actions } from "../utils/config/certification-table";
import CertificationLookup from "../apis/CertificationLookup";
...
class Certifications extends React.Component {
  ...
  async componentDidMount() {
    ...
    try {
      const response = await CertificationLookup.get("/");
...
export default withStyles(genericStyles)(Certifications);
